 ...
 *   PROFESSIONAL → cadastro do profissional  (rota futura)
 *   RECEPTIONIST → cadastro do recepcionista (rota futura)
 */
 ...
 *
 * Ambos os fluxos (paciente e clínica) redirecionam para /completar-cadastro?tempToken=JWT.
