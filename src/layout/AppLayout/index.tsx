...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/recepcao/documentos/visualizar": "Visualizar Documento",
  "/admin/documentos": "Documentos da Consulta",
  "/admin/documentos/visualizar": "Visualizar Documento",
};
...
const PAGE_BREADCRUMBS: Record<string, BreadcrumbItem> = {
  ...
  "/recepcao/documentos": {
    parent: "Histórico de Pacientes",
    parentPath: "/recepcao/historico",
    current: "Documentos da Consulta",
    currentPath: "/recepcao/documentos",
  },
  "/recepcao/documentos/visualizar": {
    grandParent: "Histórico de Pacientes",
    grandParentPath: "/recepcao/historico",
    parent: "Documentos",
    parentPath: "/recepcao/documentos",
    current: "Visualizar",
  ...
  "/admin/documentos": {
    parent: "Pacientes",
    parentPath: "/admin/paciente/dashboard",
    current: "Documentos da Consulta",
    currentPath: "/admin/documentos",
  },
  "/admin/documentos/visualizar": {
    grandParent: "Pacientes",
    grandParentPath: "/admin/paciente/dashboard",
    parent: "Documentos",
    parentPath: "/admin/documentos",
    current: "Visualizar",
  ...
  "/paciente/documentos": {
    parent: "Agendamentos",
    parentPath: "/paciente/agendamentos",
    current: "Meus Documentos",
    currentPath: "/paciente/documentos",
  },
  "/paciente/documentos/visualizar": {
    grandParent: "Agendamentos",
    grandParentPath: "/paciente/agendamentos",
    parent: "Documentos",
    parentPath: "/paciente/documentos",
    current: "Visualizar",
